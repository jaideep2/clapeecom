...
def process(topic="Benefits of drinking coffee", progress=gr.Progress()):
...
app = gr.Interface(process, gr.Textbox(lines=1, placeholder="Benefits of drinking tea"), gr.Text())
app.queue()
app.launch()